...
const DaftarInstruktur: React.FC = () => { // PERBAIKAN: Sesuaikan nama komponen
  ...
  const fetchInstrukturs = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.get<{ data: InstructorData[] }>('/instruktur/daftar-instruktur');
