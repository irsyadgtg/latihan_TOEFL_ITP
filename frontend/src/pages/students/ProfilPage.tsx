...
import { FaEdit } from "react-icons/fa"; // Icon edit
// Hapus import DayPicker dan date-fns yang tidak lagi digunakan
// import { format, parseISO, differenceInDays } from 'date-fns'; 
// import { DayPicker } from 'react-day-picker'; 
// import 'react-day-picker/dist/style.css'; 
// import { id as idLocale } from 'date-fns/locale'; 

import { useDashboardLayoutContext } from '../../layouts/DashboardLayout'; // Context untuk layout
import axiosInstance from "../../services/axios"; // Import axiosInstance (sudah dikonfigurasi timeout & token)
...
export default function ProfilePage() { 
  ...
  // Hapus state isCalendarOpen dan selectedDate
  ...
  // Fungsi handleDateSelect dihapus
  ...
  const handleEditToggle = async () => {
    if (isEditing) {
      ...
      // Logika tanggal lahir dihapus dari FormData
      // if (selectedDate) {
      ...
      try {
        ...
        // Asumsi ada state 'setSubmitting' yang harus diatur ke false
        // Jika tidak ada, baris ini mungkin menyebabkan error atau tidak berpengaruh
        // setSubmitting(false); 
      }
    } else {
      setIsEditing(true);
  ...
  return (
    <>
      <div className="mx-auto p-6 rounded-lg bg-white mt-4">
        {/* Bagian Header Profil (Foto, Nama, Email, ID, Tombol Edit) */}
        <div className="flex justify-between items-start pb-6 border-b border-gray-200">
          <div className="flex items-start gap-4">
            ...
            {/* Informasi Profil yang ditampilkan di header */}
        ...
        {/* Bagian Form Input Detail Profil */}
