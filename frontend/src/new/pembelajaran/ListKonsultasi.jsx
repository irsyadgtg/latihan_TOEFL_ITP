...
export default function ListKonsultasi() {
  ...
  const formatAvailabilityTime = (availabilityInfo) => {
    if (!availabilityInfo.date || !availabilityInfo.start_time || !availabilityInfo.end_time) {
  ...
  if (role !== 'peserta' && role !== 'instruktur') {
    return (
      <div style={{ 
        padding: '2rem', 
        textAlign: 'center',
    ...
    <div style={{ 
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ color: '#666', fontSize: '1rem', margin: 0 }}>
          {role === 'peserta' 
            ? 'Pilih instruktur untuk memulai konsultasi. Status ketersediaan diperbarui secara real-time.'
        ...
        {role === 'peserta' && (
          <div style={{
            ...
            <p style={{ 
              ...
              Data ketersediaan akan diperbarui otomatis setiap 30 detik.
            </p>
          </div>
        )}
      </div>
      ...
      {role === 'peserta' && !hasConsultationAccess && accessInfo && (
        <div style={{
          marginBottom: '2rem',
          padding: '2rem',
            ...
            instructors.map(instructor => {
              ...
              return (
                ...
                >
                  ...
                  {!instructor.is_available && instructor.availability_info.date && (
                    <div style={{
                      marginTop: '1rem',
                      padding: '0.75rem',
                      backgroundColor: '#fff3cd',
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  <div style={{
                    ...
                    {consultation.student?.username?.charAt(0).toUpperCase() || consultation.student?.name?.charAt(0).toUpperCase() || 'S'}
                  </div>
                  ...
                  <div style={{ flex: 1 }}>
                    <h3 style={{ 
                      ...
                      {consultation.student?.username || consultation.student?.name || 'Peserta'}
                    </h3>
                    <p style={{ 
                      margin: '0.25rem 0',
                      color: '#666',
